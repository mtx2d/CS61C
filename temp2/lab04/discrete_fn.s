...
f:
    # YOUR CODE GOES HERE!
    addi t0, a0, 3 # Gives the counter of the index number
    slli t0, t0, 2 # Gives the actual offset in relation to the array
    add t1, a1, t0 # Gives a pointer to the elemnt we actually care about
    lw a0, 0(t1) # Loads the actual element from the address back into the argument register
